...
\emph{(i)} \texttt{FullAxiomModel.lean} interprets Forms as pairs $(n,b) \in \N \times \mathrm{Bool}$ with $\mathrm{Simulation}$ read as strict syntactic identity. There \texttt{full\_\allowbreak axioms\_\allowbreak hold} establishes $\mathcal{C}$ and \texttt{self\_\allowbreak derivation\_\allowbreak target\_\allowbreak fails} establishes $\neg S$; their conjunction is \texttt{full\_\allowbreak clauses\_\allowbreak without\_\allowbreak cycle\_\allowbreak or\_\allowbreak nontrivial\_\allowbreak simulation}.

\emph{(ii)} \texttt{FiniteAction\allowbreak Countermodel.lean} interprets Forms over six elements, ground lying in a two-cycle and the limit in a disjoint three-cycle. There \texttt{full\_\allowbreak axioms\_\allowbreak hold} again establishes $\mathcal{C}$, while \texttt{self\_\allowbreak derivation\_\allowbreak target\_\allowbreak holds} establishes $S$; their conjunction is \texttt{full\_\allowbreak clauses\_\allowbreak and\_\allowbreak target\_\allowbreak without\_\allowbreak nonzero\_\allowbreak D}.
\end{proof}
