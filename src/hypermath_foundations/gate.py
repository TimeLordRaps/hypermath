...
def evaluate_gate(report, claim="self_derivation", *, require_clean=True) -> bool:
    ...
    try:
        ...
        required = {"L0_ground.hm", "L1_relations.hm", "L2_operations.hm", "L3_ordinatics.hm",
                    ...
                    "lean4/Hypermath/GroundDerivation.lean", "lean4/GroundDerivationChecks.lean",
                    "lean4/Hypermath/GroundCode.lean", "lean4/Hypermath/RecordEncoding.lean",
                    "lean4/RecordEncodingChecks.lean",
                    "lean4/Hypermath/RecordMachine.lean", "lean4/RecordMachineChecks.lean",
                    "lean4/Hypermath/RuleSubstitution.lean", "lean4/Hypermath/Sequential.lean",
                    "lean4/Hypermath/UnaryFormation.lean",
                    "lean4/Hypermath/LayeredDerivation.lean", "lean4/LayeredDerivationChecks.lean",
